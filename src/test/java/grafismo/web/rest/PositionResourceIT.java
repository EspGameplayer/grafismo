...
class PositionResourceIT {
    ...
    public static Position createEntity(EntityManager em) {
        Position position = new Position().name(DEFAULT_NAME).abb(DEFAULT_ABB);
        return position;
    }
    ...
    public static Position createUpdatedEntity(EntityManager em) {
        Position position = new Position().name(UPDATED_NAME).abb(UPDATED_ABB);
        return position;
    }
    ...
    void createPosition() throws Exception {
        ...
        assertThat(testPosition.getAbb()).isEqualTo(DEFAULT_ABB);
    }
    ...
    void putNewPosition() throws Exception {
        ...
        updatedPosition.name(UPDATED_NAME).abb(UPDATED_ABB);
        ...
        assertThat(testPosition.getAbb()).isEqualTo(UPDATED_ABB);
    }
    ...
    void partialUpdatePositionWithPatch() throws Exception {
        ...
        partialUpdatedPosition.abb(UPDATED_ABB);
    ...
    void fullUpdatePositionWithPatch() throws Exception {
        ...
        partialUpdatedPosition.name(UPDATED_NAME).abb(UPDATED_ABB);
