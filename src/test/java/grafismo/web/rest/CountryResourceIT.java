...
import grafismo.repository.CountryRepository;
import grafismo.service.dto.CountryDTO;
import grafismo.service.mapper.CountryMapper;
...
class CountryResourceIT {
    ...
    public static Country createEntity(EntityManager em) {
        Country country = new Country().name(DEFAULT_NAME).abb(DEFAULT_ABB).flag(DEFAULT_FLAG).flagContentType(DEFAULT_FLAG_CONTENT_TYPE);
        return country;
    }
    ...
    public static Country createUpdatedEntity(EntityManager em) {
        Country country = new Country().name(UPDATED_NAME).abb(UPDATED_ABB).flag(UPDATED_FLAG).flagContentType(UPDATED_FLAG_CONTENT_TYPE);
        return country;
    }
    ...
    void createCountry() throws Exception {
        ...
        assertThat(testCountry.getAbb()).isEqualTo(DEFAULT_ABB);
        assertThat(testCountry.getFlag()).isEqualTo(DEFAULT_FLAG);
        assertThat(testCountry.getFlagContentType()).isEqualTo(DEFAULT_FLAG_CONTENT_TYPE);
    }
    ...
    void putNewCountry() throws Exception {
        ...
        updatedCountry.name(UPDATED_NAME).abb(UPDATED_ABB).flag(UPDATED_FLAG).flagContentType(UPDATED_FLAG_CONTENT_TYPE);
        ...
        assertThat(testCountry.getAbb()).isEqualTo(UPDATED_ABB);
        assertThat(testCountry.getFlag()).isEqualTo(UPDATED_FLAG);
        assertThat(testCountry.getFlagContentType()).isEqualTo(UPDATED_FLAG_CONTENT_TYPE);
    }
    ...
    void partialUpdateCountryWithPatch() throws Exception {
        ...
        partialUpdatedCountry.name(UPDATED_NAME).abb(UPDATED_ABB).flag(UPDATED_FLAG).flagContentType(UPDATED_FLAG_CONTENT_TYPE);
