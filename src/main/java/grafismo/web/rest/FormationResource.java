...
import grafismo.service.FormationService;
...
/**
 * REST controller for managing {@link grafismo.domain.Formation}.
 */
@RestController
@RequestMapping("/api")
public class FormationResource {
    ...
    public ResponseEntity<List<FormationDTO>> getAllFormations(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
