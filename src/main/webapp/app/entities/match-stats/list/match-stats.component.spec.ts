...
describe('MatchStats Management Component', () => {
  let comp: MatchStatsComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(MatchStatsComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.matchStats[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
