...
describe('ActionKey Management Component', () => {
  let comp: ActionKeyComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [ActionKeyComponent],
    })
      .overrideTemplate(ActionKeyComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.actionKeys[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
