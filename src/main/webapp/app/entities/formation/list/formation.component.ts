...
export class FormationComponent implements OnInit {
  ...
  constructor(protected formationService: FormationService, protected modalService: NgbModal, protected parseLinks: ParseLinks) {
    this.formations = [];
  ...
  trackId(_index: number, item: IFormation): number {
    return item.id!;
  }
