...
export class CompetitionComponent implements OnInit {
  ...
  constructor(protected competitionService: CompetitionService, protected modalService: NgbModal, protected parseLinks: ParseLinks) {
    this.competitions = [];
  ...
  protected paginateCompetitions(data: ICompetition[] | null, headers: HttpHeaders): void {
