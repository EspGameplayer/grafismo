...
describe('CompetitionPlayer Management Component', () => {
  let comp: CompetitionPlayerComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(CompetitionPlayerComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.competitionPlayers[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
