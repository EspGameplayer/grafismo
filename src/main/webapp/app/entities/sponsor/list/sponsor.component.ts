...
export class SponsorComponent implements OnInit {
  ...
  loadAll(): void {
    ...
    this.sponsorService
      ...
      .subscribe({
        next: (res: HttpResponse<ISponsor[]>) => {
          this.isLoading = false;
          this.paginateSponsors(res.body, res.headers);
        },
        error: () => {
          this.isLoading = false;
        },
  ...
  trackId(_index: number, item: ISponsor): number {
    return item.id!;
  }
  ...
  protected paginateSponsors(data: ISponsor[] | null, headers: HttpHeaders): void {
