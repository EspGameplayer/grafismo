...
describe('Matchday Management Component', () => {
  let comp: MatchdayComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(MatchdayComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.matchdays[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
