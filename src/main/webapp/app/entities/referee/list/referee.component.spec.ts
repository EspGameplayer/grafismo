...
describe('Referee Management Component', () => {
  let comp: RefereeComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(RefereeComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.referees[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
